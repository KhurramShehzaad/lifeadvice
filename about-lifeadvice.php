...
<img src="images/insure2.png">
<h3>Multi Insurance Choices</h3>
...
<br>
<br>
<img src="images/insure1.png">
<h3>We get You Covered </h3>
...
<img src="images/insure3.png">
<h3>An Honest Guide</h3>
...
<br>
<br>
<img src="images/insure4.png">
<h3>Perfect Policy Plans</h3>
...
<div class="col-md-4">
<div class="about"><i class="fa fa-check-square-o"></i>
<h2> Our Vision</h2>
...
<div class="col-md-4">
<div class="about"><i class="fa fa-lightbulb-o"></i>
<h2> Our knowledge</h2>
...
<div class="col-md-4">
<div class="about"><i class="fa fa-briefcase"></i>
...
<div class="container bg"><div class="row align-items-center">
<div class="col-md-6 pl-0 pr-0"><img src="images/about.jpg"></div>
<div class="col-md-6"><div class="col-md-12">
<h1>Best of our Plans</h1>
<br>
...
<div class="col-md-6"><div class="col-md-12">
<h1>Life Advice Online Support</h1>
<br>
...
<div class="col-md-6 pl-0 pr-0"><img src="images/about3.jpg"></div>
</div></div>
...
<div class="col-md-3 col-sm-6"><h3>1450</h3><h4>Happy Client</h4></div>
<div class="col-md-3 col-sm-6"><h3>35</h3><h4>Insurance Products </h4></div>
<div class="col-md-3 col-sm-6"><h3>10</h3><h4>Years of Experience</h4></div>
<div class="col-md-3 col-sm-6"><h3>196</h3><h4>Professional Agents</h4></div>
...
<h1 class="py-2">You Can Trust Us</h1>
<p>
...
<div class="col-md-6">
<h1>Our Plenge</h1>
<p class="pt-4">Lifesadvice will be providing ongoing support and helpful articles that will provide our readers with all of the latest info on insurance products and requirements for travel and immigration. Through our resources and our skilled staff members, we can make insurance products more accessible and affordable than ever before.</p><br>
<p>Travel insurance and medical insurance is something that we are extremely passionate about. These types of insurance products provide support to help individuals save millions of dollars every year. By spending just a few extra dollars on the cost of your trip or with our help and research we can identify the best products that can be used to protect you in an emergency or make sure that you are compliant with visa standards.</p>
</div>

<div class="col-md-6 text-center text-md-right"><img src="images/lifeadvice-policy.png"></div>

</div>
</div>

<div class="container-fluid my-0 bg bg-success"><div class="container py-4">
<h2 class="text-white text-center"><i class="fa fa-quote-left"></i></h2>
<h3 class="text-white text-center col-md-6 offset-md-3">Like to learn more about our company and what we can offer through our products and services.</h3>
