						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Manage expired documents report and more:
								</small>
							</h1>
						</div><!-- /.page-header -->
										...
										<div class="tabbable">
											...
											<div class="tab-content no-border padding-24">
												<div id="documents" class="tab-pane in active">
                                                    ...
                                                    <form method="post" action="doc_expired_excel.php" target="_blank">
                                                    <button type="submit" style="padding: 2px;" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Download Report</button>
                                                    </form>
                                                    		<h4 class="red">
