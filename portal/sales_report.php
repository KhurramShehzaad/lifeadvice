                            ...
                            <form method="post" action="?action=done" id="form">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <?php $agent_q = mysqli_query($db, "SELECT * FROM `users` WHERE `user_type`='agent' AND `parent_id`='0' ORDER BY `fname`");
                                            ...
                                            <?php } ?>
                                            <?php $broker_q = mysqli_query($db, "SELECT * FROM `users` WHERE `user_type`='broker' ORDER BY `fname`");
                                            ...
                                            <?php $agent_q = mysqli_query($db, "SELECT * FROM `users` WHERE `user_type`='agent' AND `parent_id`='".$broker_f['id']."' ORDER BY `fname`");
											while($agent_f = mysqli_fetch_assoc($agent_q)){
											?>
                                            <option <?php if($_POST['seller'] == $agent_f['unique_code']){?> selected <?php } ?> value="<?php echo $agent_f['unique_code'];?>"><i class="fa fa-user"></i>  <?php echo $agent_f['fname'].' '.$agent_f['lname'].' - '.$agent_f['unique_code'];?></option>
                                            <?php } ?>
                                            ...
                                            <?php $agent_q = mysqli_query($db, "SELECT * FROM `users` WHERE `user_type`='agent' AND `parent_id`='".$_SESSION['portal_id']."' ORDER BY `fname`");
											while($agent_f = mysqli_fetch_assoc($agent_q)){
											?>
                                            <option <?php if($_POST['seller'] == $agent_f['unique_code']){?> selected <?php } ?> value="<?php echo $agent_f['unique_code'];?>"><i class="fa fa-user"></i>  <?php echo $agent_f['fname'].' '.$agent_f['lname'].' - '.$agent_f['unique_code'];?></option>
                                            <?php } ?>
                                            <?php $broker_q = mysqli_query($db, "SELECT * FROM `users` WHERE `user_type`='broker' AND `parent_id`='".$_SESSION['portal_id']."' ORDER BY `fname`");
											while($broker_f = mysqli_fetch_assoc($broker_q)){
											?>
                                            <option value="b_<?php echo $broker_f['id'];?>" style="font-weight:bold;"><i class="fa fa-user-secret"></i> <?php echo $broker_f['fname'].' '.$broker_f['lname'].' - '.$broker_f['unique_code'];?></option>
                                            <?php $agent_q = mysqli_query($db, "SELECT * FROM `users` WHERE `user_type`='agent' AND `parent_id`='".$broker_f['id']."' ORDER BY `fname`");
