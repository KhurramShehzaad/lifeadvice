...
<h1 class="head">Critical Illness
    ...
    <div class="carousel-item">
	  ...
	  <div class="container-fluid trust" style="height: auto;padding: 50px 0;">
        <div class="container">
          <div class="row row-40">
            ...
            <div class="col-sm-6 col-md-6">
              <ul>
				<li style="list-style: none;"><h2 style="font-size: 18px; color: #ffffff; font-style: default;margin-bottom: 10px;"><i class="fa fa-check-circle" aria-hidden="true" style="font-size: 25pxpx; color: #1bbc9b;"></i> Cancer </h2></li>
				<li style="list-style: none;"><h2 style="font-size: 18px; color: #ffffff; font-style: default;margin-bottom: 10px;"><i class="fa fa-check-circle" aria-hidden="true" style="font-size: 25pxpx; color: #1bbc9b;"></i> Heart Attack </h2></li>
				<li style="list-style: none;"><h2 style="font-size: 18px; color: #ffffff; font-style: default;margin-bottom: 10px;"><i class="fa fa-check-circle" aria-hidden="true" style="font-size: 25pxpx; color: #1bbc9b;"></i> Strokesand Coronary Heart Bypass Surgery </h2></li>
			  </ul>
            </div>
          </div>
        </div>
      ...
      <section class="section-66 section-md-90 section-xl-bottom-120" style="padding: 60px 0;">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-center" style="font-size: 34px;font-weight: bold;margin-bottom: 30px;">Coronary Heart Bypass Surgery</h3>
        ...
        <div class="container">
          <div class="row row-40">
            ...
            <div class="col-xs-12 col-md-12" style="background:#FFF; margin-bottom:10px; padding:10px 20px;">
              <h4>Term based Policies</h4><p>You can buy a policy for a term as per your needs. Various term options available are Term 10, Term 20, Term 65, Term 75 and Term 100. Mostly you get coverage till the age of 75 at max.</p>
            </div>
			<div class="col-xs-12 col-md-12" style="background:#FFF; margin-bottom:10px; padding:10px 20px;">
              <h4>Return of Premiums</h4><p>You also have an option to add Return of Premiums (ROP) option to your policy. If you claim all the premiums paid towards the policy, the coverage ends. If you go for a partial refund then the insured amount automatically reduces in accordance with the amount you claim. It is however advisable to seek the help of professional advisor at the time of buying the policy. ROP is mostly available for Term 65 and above only.</p>
            </div>
			<div class="col-xs-12 col-md-12" style="background:#FFF; margin-bottom:10px; padding:10px 20px;">
              <h4>Special Cases</h4><p>No Claim made: Some companies pay back the premiums paid towards the policy in an event when the insured individual dies within the waiting period, due to a cause not covered by the policy. The amount is paid to the nominated beneficiary in the contract. In some products, the company pays back a portion of premium if the insurance in unclaimed till its maturity.</p>
            </div>
			<div class="col-xs-12 col-md-12" style="background:#FFF; margin-bottom:10px; padding:10px 20px;">
              <h4>Full Recovery</h4><p>You get a full coverage as long as you fulfill the waiting period mentioned in the policy. Even if the policy holder recovers fully, still he/she will get the entitled coverage in the policy.</p>
            </div>
          </div>
        </div>
