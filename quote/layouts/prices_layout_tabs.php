...
if(displayvalue == '0'){
	...
	document.getElementById('change_display').value = '0';	
        ...
        <div class="col-md-3 side-bar filterdiv hidden-xs" style="margin: 0;margin-top: -50px;height: 100%;">
            <div class="col-md-12">
                    ...
                    <div class="desktop-compare listing-item" data-listing-price="<?php echo str_replace(',', '', number_format($total_price));?>">
                        <div class="coverage-amt coverage-amt-<?php echo $sum_insured; ?>"
                            ...
                            <div class="row plan-details   deductable-<?php echo $deductible; ?>"
                                 style="border:1px solid #c0c0c0; margin-bottom: 20px; display: <?php if($deductible == '1000'){ echo 'block'; } else if($havethousand == 'no' && $deductible == '0'){ echo 'bock'; } else { echo 'none'; } ?>;">
...
<input data-productid="<?php echo $product_id; ?>" data-pid="<?php echo $plan_id; ?>" type="checkbox" tabindex="0" class="hidden1" value="<?php echo $total_price; ?>" style="height: auto;margin: 0 auto;" onclick="comparetest()"> Compare
</label>												
...
<p></p>
<p><a class="submit-btn" href="vtc_tab_buy.php" style="display: block;"><i class="fa fa-shopping-cart"></i> Buy Now</a></p>
</div>
...
$("#listprices").html(divList);
	...
	<?php
	$counter = 0;
	if ( ! empty( $mailitem ) && ! isset( $_SESSION['fromemail'] ) ) {
