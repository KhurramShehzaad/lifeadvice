...
document.getElementById('phone_error').innerHTML = '';
          ...
          <!-- end -->
           ...
           <!-- Start Date  and End date -->
            ...
            <input  id="departure_date"  name="departure_date" value="<?php echo $_SESSION['departure_date'];?>"  class="form-control"  type="<?php if($mobile == 'yes'){ echo 'date'; } else { echo 'text'; } ?>" placeholder="Start Date" required <?php if($supervisa == 'yes'){?> onchange="supervisayes()" <?php } ?>>
			<?php if($mobile == 'no'){?>
					<script>
						$('#departure_date').datepicker({
						format: 'yyyy-mm-dd',
			...
			<?php } ?>
				...
				<div class="col-md-6 col-sm-6 col-xs-12 control-input">
                        ...
                        <input id="return_date" name="return_date" class="form-control" value="<?php echo $_SESSION['return_date'];?>" type="<?php if($mobile == 'yes'){ echo 'date'; } else { echo 'text'; } ?>" required <?php if($supervisa == 'yes'){?> readonly="true" <?php } ?>>
