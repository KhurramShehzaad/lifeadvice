	...
	document.getElementById('change_display').value = '0';	
        ...
        <div class="col-md-3 side-bar filterdiv hidden-xs">
            ...
            <div class="col-md-12 adjust-quoto" style="border: none;">
                ...
                <h2 style="margin: 0;font-size: 24px;font-weight: bold;">Adjust your quotes</h2>
        ...
        <div class="col-md-9 right-bar-content" id="listprices">
			<?php
		$addinquery = '';
...
?>
                    <div class="desktop-compare listing-item" data-listing-price="<?php echo str_replace(',', '', number_format($total_price));?>">
                        <div class="coverage-amt coverage-amt-<?php echo $sum_insured; ?>"
                             style="display: <?php if($_SESSION['sum_insured2'] == $sum_insured ){ echo 'block'; } else { echo 'none'; } ?>;">
                            <div class="row plan-details   deductable-<?php echo $deductible; ?>"
                                 style="border:1px solid #c0c0c0; margin-top: 10px !important; margin-bottom: 15px !important; display: <?php if($deductible == '1000'){ echo 'block'; } else if($havethousand == 'no' && $deductible == '0'){ echo 'bock'; } else { echo 'none'; } ?>;">
                                <div class="col-md-2 col-sm-6 hidden-xs" style="padding-top:10px;">
                                    <div class=" center aligned middle aligned column">
                                        <div class="compare col-md-12 text-center">
                                            <i class="fa fa-exclamation-circle dh-toggle hidden-md" data-value='<?php echo $sum_insured.$deductible.$plan_id; ?>' style="cursor:pointer;position: absolute;top: 40%;left: -10px;" aria-hidden="true"></i> 
...
<label class="sub header"><input data-productid="<?php echo $product_id; ?>" data-pid="<?php echo $plan_id; ?>" price="<?php echo str_replace(',', '', number_format($total_price,2));?>" type="checkbox" tabindex="0" class="hidden1" value="<?php echo str_replace(',', '', number_format($total_price,2));?>" style="height: auto;margin: 0 auto; display:block;" onclick="comparetest()"> Compare</label>
                                ...
                                <div class="col-md-3 col-xs-6 logogd"
                                    ...
                                    <img style="width:auto;" src="admin/uploads/<?php echo $comp_logo; ?>" class="img-responsive"/>

                                </div>
                                <div class="col-md-4 col-xs-6 text-center" id="price">

                                    <h3 style="display:inline;margin:0;font-size:30px;">
                                        $<?php $explode = explode('.',number_format($total_price,2));
										?><span style="color: #000;font-weight: bold;"><?php echo str_replace(',', '',$explode[0]).'.';?><sup class="superior" style="font-size: 17px;"><?php echo $explode[1];?></sup></span></h3>
		...
		<?php } ?>	
								...
								<div class="col-md-3 col-xs-6 visible-xs text-center" style="clear: both;padding-top: 16px;padding-left: 0;">
								<a data-value='<?php echo $sum_insured.$deductible.$plan_id; ?>' class='dh-toggle btn btn-default' style="cursor:pointer;width: 100%;" aria-hidden="true"><i class="fa fa-exclamation-circle"></i> Info</a>

								</div>


								<div class="col-md-3 col-xs-6" style="border:0px solid #000;text-align:center;padding-top:15px;padding-left: 0;padding-right: 0;">
...
?>
                                ...
                                <div class="col-md-12 dh-toggle-show-hide-<?php echo $sum_insured.$deductible.$plan_id; ?>"
...
<p></p>
<p><button type="submit" class="submit-btn" style="display: block;"><i class="fa fa-shopping-cart"></i> Buy Now</button></p>
</div>
