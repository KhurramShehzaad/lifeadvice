...
border: 5px solid #1BBC9B !important;
...
?>
    ...
    <div class="coverage-amt col-md-12 coverage-amt-<?php echo $sum_insured; ?>" style="<?php echo ( $_SESSION['sum_insured2'] == $sum_insured ) ? '' : 'display:none;'; ?> padding:0; ">
                            <div class="row plan-details   deductable-<?php echo $deductible; ?>" style="border:2px solid #c0c0c0; margin-bottom: 10px !important; padding:10px 0 0; display: <?php if($deductible == '1000'){ echo 'block'; } else if($havethousand == 'no' && $deductible == '0'){ echo 'bock'; } else { echo 'none'; } ?>;">
...
<img style="width:auto;border: 2px solid #c0c0c0;padding: 15px;max-height: 80px;margin-top: -40px;background: #FFF;" src="admin/uploads/<?php echo $comp_logo; ?>" class="img-responsive" />
