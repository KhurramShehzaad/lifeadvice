...
border: 5px solid #F46D00 !important;
...
<?php
if(isset($_REQUEST['sum_insured2']))
{
...
.wizzard ul li.active span strong {
  background-color: #00c2a2;
}

.wizzard ul li.active span i {
  color: #00c2a2;
}

.wizzard ul li.passed span strong {
  top: 0 !important;
  background-color: #00c2a2;
}

.wizzard ul li.passed span i {
  color: #00c2a2;
}

.wizzard ul li.passed em {
  background-color: #00c2a2;
}

.wizzard ul li:nth-child(2) span strong {
  top: 60%;
}

.wizzard ul li:nth-child(3) span strong {
  top: 40%;
}

.wizzard ul li:nth-child(4) span strong {
  top: 20%;
}

.wizzard ul li:nth-child(5) span strong {
  top: 0;
}

.wizzard ul li:nth-child(5) em {
  display: none;
}
...
<div class="container">
<ul>
<li class="active passed" id="set1"><a href="#" onclick="history.go(-1)+'action=back'"><p>About You</p><span><i>1</i><strong></strong></span><em></em></a></li>
<li class="active" id="set2"> <p>See Rates &amp; Select Your Plan</p><span><i>2</i><strong></strong></span><em></em> </li>
...
if(displayvalue == '0'){
	...
	document.getElementById('change_display').value = '0';	
	        ...
	        <div class="col-md-3 side-bar filterdiv hidden-xs" style="margin:10px 0;">
			       <div class="col-md-12 quote_reference text-center">
            <small><?php
...
?>
    ...
    <div class="coverage-amt col-md-12 coverage-amt-<?php echo $sum_insured; ?>" style="<?php echo ( $_REQUEST['sum_insured2'] == $sum_insured ) ? '' : 'display:none;'; ?> padding:0; ">
                            <div class="row plan-details   deductable-<?php echo $deductible; ?>" style="border:1px solid #c0c0c0; margin-bottom: 20px; padding:5px;  display: <?php if($deductible == '1000'){ echo 'block'; } else if($havethousand == 'no' && $deductible == '0'){ echo 'bock'; } else { echo 'none'; } ?>;">
                                <div class="col-md-5 col-sm-6 logogd" style="border: 0px solid #000;text-align: center;padding: 10px;text-align: center;background: #EEE;height: 100px;border-radius: 10px;">
                                    <img style="max-height:60px; width:auto; margin-left: 20px"
                                         src="images/<?php echo $comp_logo; ?>"/>
										 
										 <div class="compare center aligned middle aligned column">
                                        <div class="ui center aligned header">
										<button class="btn dh-toggle" data-value='<?php echo $plan_id; ?>' aria-hidden="true" style="text-transform: none;font-weight: normal; box-shadow: 1px 1px 3px 0px #333; cursor:pointer;">
										Summary & Info
                                ...
                                <div class="col-md-4 col-sm-6" style="border:0px solid #000; padding: 5px 0; text-align: center" id="price">
                                    <h3 style="margin-bottom:0;">
                                        <?php $explode = explode('.',number_format($total_price,2));
										?><span><sup class="superior">$</sup><?php echo $explode[0].'.';?><sup class="superior"><?php echo $explode[1];?></sup></span></h3>
                                ...
                                <div class="col-md-2 col-sm-6" style="border:0px solid #000;text-align:center;">
<?php
...
?>
                                    <button onclick="$('.buynow_<?php echo $deductible.$plan_id;?>').fadeIn();" class="buynow-btn"
                                            ...
                                            name="buynow" style="color:#FFF;margin-top: 20px;width: 100%;border-radius: 5px;font-weight: bold;">Buy Now
                                    </button>
                                    </td>
                                </div>
                                    ...
                                    <div class="compare center aligned middle aligned column">
                                        <div class="ui center aligned header">
												<div class="field">
												<div class="ui checkbox large nopad">
                                                    <input data-productid="<?php echo $product_id; ?>"
                                                           data-pid="<?php echo $plan_id; ?>" price="<?php echo str_replace(',', '', number_format($total_price));?>" style="width: 20px;"
                                                           type="checkbox" tabindex="0" class="hidden1" value="<?php echo str_replace(',', '', number_format($total_price));?>" onclick="comparetest()">
                                                    <label></label>
                                                </div>
												</div>
                                ...
                                <div class="col-md-12 dh-toggle-show-hide-<?php echo $plan_id; ?>"  style="display:none; margin-top: 20px;border-top: 1px solid #ddd;font-family: arial;">
                                    <div class="col-md-6">
                                        ...
                                        <div style="font-size:12px;">
                                            <p style="margin:0;"><b>Plan:</b> <?php if($family_plan == 'yes'){ echo 'Family'; } else {echo 'Individual';}?></p>
...
$person_price = ($person_price - $p_discount) + $p_others;
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <span style="display: none;"><?// "SELECT * FROM {$wpdb->prefix}dh_insurance_plans_rates WHERE minage <= '$year' AND maxage >= '$year' and sum_insured ='".$_REQUEST['sum_insured2']."' limit 1000" ?></span>
                                        <hr/>
										<?php
...
<p></p>
<p><a class="submit-btn" href="<?php echo $buynow_url;?>" style="color:#FFF;border-radius: 5px;font-weight: bold; display:block;background:#F46D00;"><i class="fa fa-shopping-cart"></i> Buy Now</a></p>
</div>
