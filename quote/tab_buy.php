...
$comp_q = mysqli_query($db, "SELECT * FROM `wp_dh_companies` WHERE `comp_id`='$comp_id'");
$comp_f = mysqli_fetch_assoc($comp_q);
$comp_name = $comp_f['comp_name'];
$comp_logo = $comp_f['comp_logo'];

if($_REQUEST['action'] == 'post'){
	$fname = $_POST['fname'];
	$lname = $_POST['lname'];
	$dob = $_POST['day_birth'].'-'.$_POST['month_birth'].'-'.$_POST['year_birth'];
	$coa = $_POST['coa'];
	$visitor = $_POST['visitor_visa_type'];  //$_POST['visitor'];
	$age = $_SESSION['years'][0];

	$beneficiary_fname =  $_POST['beneficialfname']; // $_POST['beneficiary_fname'];
	$beneficiary_lname = $_POST['beneficiallname']; // $_POST['beneficiary_lname'];
	$beneficiary_email = $_POST['beneficialemail']; // $_POST['beneficiary_email'];
if($beneficiary_fname != '' || $beneficiary_lname |= ''){
$beneficiary_section = "
<h4>Beneficiary Information</h4>
<table>
	<tr>
		<td>First Name:</td>
		<td>$beneficiary_fname</td>
	</tr>
	<tr>
		<td>Last Name:</td>
		<td>$beneficiary_lname</td>
	</tr>
	<tr>
		<td>Email:</td>
...
$additional_travellers_info = '';
$travellers = $_SESSION['number_travelers'] - 1;
for ($x = 1; $x <= $travellers; $x++) {
$applicant_num = $x+1;
$additional_travellers_info .= "
<h4>Additional Traveller (Applicant ".$applicant_num.")</h4>
<table>
	<tr>
		<td>First Name:</td>
		<td>".$_POST['add_'.$x.'_fname']."</td>
	</tr>
	<tr>
		<td>Last Name:</td>
		<td>".$_POST['add_'.$x.'_lname']."</td>
	</tr>
	<tr>
		<td>Date of Birth:</td>
		<td>".$_POST['add_'.$x.'_day_birth']."-".$_POST['add_'.$x.'_month_birth']."-".$_POST['add_'.$x.'_year_birth']." (DD-MM_YYYY)</td>
	</tr>
	<tr>
		<td>Gender:</td>
		<td>".$_POST['add_'.$x.'_gender']."</td>
	</tr>
</table>
";	
}
	...
	$trip_coverage = $_POST['typeofcoverage'];
	$trip_arrival_date = $_POST['tripdate'];
	$trip_visa_type = $_POST['visa_type'];
	$trip_end_date = $_POST['tripend'];
	$trip_duration = $_POST['tripduration'];

	$address_name = $_POST['streetname'];
	$address_apt = $_POST['suit'];
	$address_city = $_POST['city'];
	$address_province = $_POST['province'];
	$address_pcode = $_POST['postalcode'];
	$address_phone = $_POST['phone'];
	$address_email = $_POST['useremail'];
	...
	$product_coverage = $_POST['coverage'];
	$product_deductable = $_POST['deductibles'];
	$product_deductible_rate = $_POST['deductible_rate'];
	$product_premium = $_POST['premium'];
	$product_plan = $_POST['plan_name'];
	$product_plan_id = $_POST['plan_id'];
	$product_comp_id = $_POST['comp_id'];
	$product_comp_name = $_POST['comp_name'];
	$product_product_id = $_POST['product_id'];
	$product_traveller = $_POST['traveller'];
	$broker = $_POST['broker']; if($broker == ''){ $broker = '0'; }
	$agent = $_POST['agent']; if($agent == ''){ $agent = '0'; }
	$user_id = $_SESSION['user_id']; if($user_id == ''){ $user_id = '0'; }	

mysqli_query($db, "INSERT INTO `sales`(`policy_id`, `policy_title`, `fname`, `lname`, `email`, `phone`, `address`, `address_2`, `city`, `postcode`, `country`, `billing_province`, `deductible`, `deductible_rate`, `benefit`, `duration`, `age`, `product`, `plan`, `dob`, `start_date`, `end_date`, `departure_date`, `arrival_date`, `return_date`, `additional_travellers`, `price_total`, `price_payable`, `broker`, `agent`, `user_id`) VALUES ('$product_plan_id','$product_plan','$fname','$lname','$address_email','$address_phone','$address_name','$address_apt','$address_city','$address_pcode','CA','$address_province','$product_deductable','$product_deductible_rate','$product_coverage','$trip_duration','$age','$product_product_id','$product_plan','$dob','$trip_arrival_date','$trip_end_date','$trip_arrival_date','$trip_arrival_date','$trip_end_date','$product_traveller','$product_premium','$product_premium','$broker','$agent','$user_id')");

$lastid = $db->insert_id;

mysqli_query($db, "INSERT INTO `sales_cards`(`card_name`, `card_number`, `card_month`, `card_year`, `card_cvc`, `sales_id`) VALUES ('$card_name','$card_number','$card_month','$card_year','$card_cvc','$lastid')");
mysqli_query($db, "INSERT INTO `sales_transactions`(`sales_id`, `payment_type`, `description`, `amount`) VALUES ('$lastid', 'payment', 'Policy Purchase Payment', '$product_premium')");
...
<body>
	<div class='product-purchased'>
		<div class="template-header">
			<img class="entry-logo img-responsive" src="https://lifeadvice.ca/images/brand.png" alt="Life Adivce Insurance Inc." title="Life Adivce Insurance Inc.">
		</div>
		<div class="template-body">
			<div class="template-data">
				...
				<table>
					...
					<tr>
						<td>Trip Duration: </td>
						<td>$trip_duration ($trip_arrival_date - $trip_end_date)</td>
					</tr>
					<tr>
						<td>Address: </td>
						<td>
							Apartment - $address_apt, $address_name <br/>
							$address_city, $address_province.<br/>
							$address_pcode
						</td>
					</tr>
				</table>
				...
				<table>	
					...
					<tr>
						<td>Coverage: </td>
						<td>$product_coverage</td>
					</tr>
					<tr>
						<td>Deductible: </td>
						<td>$product_deductable</td>
					</tr>
					<tr>
						<td>Premium: </td>
						<td>$product_premium</td>
					</tr>
					<tr>
						<td>Insurance Company: </td>
						<td>$product_comp_name</td>
					</tr>
				</table>
				$additional_travellers_info
				$beneficiary_section
...
EOD;
	$tomail = 'purchase@lifeadvice.ca';
	//$tomail = '';
	$frommail = 'info@lifeadvice.ca';
	$subject = $visitor.' - New Purchase';
...
echo "<script>window.location='?action=done';</script>";
}
?>
<html>
	<head>
...
.form-control:focus {
	box-shadow: 0px 0px 1px 1px #1BBC9B;
}
.form-control:hover {
	box-shadow: 0px 0px 1px 1px #1BBC9B;
}
...
<section class="tabscontent" style="background:#FCFCFD;">
<form action="?action=post" method="post" class="j-forms j-multistep sk78" id="payment" novalidate="novalidate">
<?php if($_REQUEST['action'] == 'done'){?>
<div class="row">
<div class="col-md-12 text-center">
<h1 class="text-center">Purchase Completed!</h1>
<p class="sub-heading">You Will Receive Your Policy by E-Mail Shortly</p>
</div>
</div>
...
<h3 class="text-center"><strong>Welcome, let's get your <?php echo $pro_name;?> sorted out</strong></h3>
...
<div class="row">
<div class="col-md-10 col-lg-offset-1 fields" style="background: none;border: none;box-shadow: none;">

<?php if($_REQUEST['action'] == 'done'){?>
<div class="success-msg" style="padding-bottom:50px;" >
	<!-- policy information -->
<div class="col-md-12">
<div class="col-md-12 p-r-30 p-r-sm-15 text-center">
<i class="fa fa-thumbs-up congrat_ico" style="font-size: 52px;"></i> <h3>Congratulations!</h3>
<p id="fep_message">Your policy should be arriving in your e-mail momentarily.<br> Please take the time to review it and contact us if you have any questions or concerns.&nbsp;</p>
<p></p>
<div class="row">
<div class="col-md-12 ">
<a href="/" class="btn btn-default green_btn btn-lg m-t-15 m-b-50 "> &nbsp; &nbsp; FINISH <span></span><i class="fa fa-flag-checkered"></i></a>
</div>
</div>
</div>
<div class="clear"></div>
	</div>
	<!-- policy end information -->
</div>
<?php } else { ?>
...
<div class="col-md-12">
		...
		<fieldset class="active-fieldset">
				...
				<div class="col-md-12">
						...
						<div class="col-md-6 nopad">
						<input id="fname1" name="fname" type="text" value="<?php echo $_SESSION['fname'];?>" class="form-control" placeholder="First Name">
						</div>
				</div>
				<div class="clearfix"></div>
					<div class="col-md-12">				
						...
						<label>Last Name <small class="text-danger">*</small>
							...
							<div class="col-md-6 nopad">
										<input id="lname1" name="lname" value="<?php echo $_SESSION['lname'];?>" type="text" class="form-control" placeholder="Last Name">
							</div>
				...
				<div class="col-md-12">
					...
					<div class="date-wrapper question-answer">
						<input type="text" placeholder="DD" name="day_birth" value="<?php echo $_SESSION['days'][0];?>" maxlength="2" class="numeric lpad2 day-holder">/
						<input type="text" placeholder="MM" name="month_birth" value="<?php echo $_SESSION['months'][0];?>" maxlength="2" class="numeric lpad2 month-holder">/
						<input type="text" placeholder="YYYY" name="year_birth" value="<?php echo date('Y') - $_SESSION['years'][0];?>" maxlength="4" class="numeric lpadyear year-holder">
					</div>
					</div>
				</div>
				<div class="clearfix"></div>
				...
				<div class="col-md-12">
					<div class="col-md-6 nopad">
						<label>Country Of Residence <small class="text-danger">*</small>
					</div>
					<div class="col-md-6 nopad">
						<div class="unit">
								<input value="" class="form-control" name="coa" type="text">
						</div>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="col-md-12">
					...
					<div class="col-md-6 nopad">
						<div class="input">
							<input  id="phone"  name="phone" class="form-control" minlength="10" maxlength="10"  type="text" placeholder="Your phone number" onkeyup="validatephone()" value="<?php echo $_SESSION['phone'];?>" required>
...
document.getElementById('phone_error').innerHTML = '';
				...
				<div class="clearfix"></div>
					<div class="col-md-12">
						<div class="col-md-6 nopad">
							<label>Email Address <small class="text-danger">*</small>
						</div>
						<div class="col-md-6 nopad">
							<div class="input">
								<input id="useremail" name="useremail" class="form-control" value="<?php echo isset($_REQUEST['email'])? $_REQUEST['email'] : ""; ?>" type="text">
							</div>
						</div>
					</div>
...
?>
				<div class="form-group">
					<div class="headitem">
						<h2 style="font-size: 22px;font-weight: bold;margin-top: 20px;color:#1BBC9B;">Additional Traveller <small>(APPLICANT <?php echo $x+1;?>)</small></h2>
					</div>
				</div>
				...
				<div class="col-md-12">
						...
						<div class="col-md-6 nopad">
						<input id="add_<?php echo $x;?>_fname" name="add_<?php echo $x;?>_fname" type="text" value="" class="form-control" placeholder="First Name">
						</div>
				</div>
				<div class="clearfix"></div>
					<div class="col-md-12">				
						...
						<label>Last Name <small class="text-danger">*</small>
							...
							<div class="col-md-6 nopad">
										<input id="add_<?php echo $x;?>_lname" name="add_<?php echo $x;?>_lname" value="" type="text" class="form-control" placeholder="Last Name">
							</div>
				...
				<div class="col-md-12">
					...
					<div class="date-wrapper question-answer">
						<input type="text" placeholder="DD" name="add_<?php echo $x;?>_day_birth" value="<?php echo $_SESSION['days'][$x];?>" maxlength="2" class="numeric lpad2 day-holder">/
						<input type="text" placeholder="MM" name="add_<?php echo $x;?>_month_birth" value="<?php echo $_SESSION['months'][$x];?>" maxlength="2" class="numeric lpad2 month-holder">/
						<input type="text" placeholder="YYYY" name="add_<?php echo $x;?>_year_birth" value="<?php echo date('Y') - $_SESSION['years'][$x];?>" maxlength="4" class="numeric lpadyear year-holder">
					</div>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="col-md-12">
					...
					<div class="col-md-6 nopad">
								<select name="add_<?php echo $x;?>_gender" class="form-control" id="add_<?php echo $x;?>_gender">
...
<div class="toggle toggle-transparent toggle-noicon">
		...
		<div class="toggle-content" style="display: block;">
			...
			<div class="form-group">
					...
					<label>Address <small class="text-danger">*</small></label>
						<input id="autocomplete_search" name="autocomplete_search" type="text" class="form-control" placeholder="Enter your address here..." />
					...
					<div class="col-md-6">
						<div class="col-md-12 nopad">
							<label>Street Number and Name <small class="text-danger">*</small>
						</div>
						<div class="col-md-12 nopad">
								<div class="input">
									<input id="autocomplete_search" class="form-control" name="autocomplete_search"  type="text">
					...
					<div class="col-md-6">	
						<div class="col-md-12 nopad">
							<label>Suit/Apt# (optional)  <small class="text-danger"></small>
						</div>
						<div class="col-md-12 nopad">
							<div class="input">
					...
					<div class="col-md-6">
						<div class="col-md-12 nopad">
							<label>City <small class="text-danger">*</small>
						</div>
						<div class="col-md-12 nopad">
							<div class="input">
					...
					<div class="col-md-6">
						<div class="col-md-12 nopad">
							<label>Province <small class="text-danger">*</small>
						</div>
						<div class="col-md-12 nopad">
							<div class="input">
					...
					<div class="col-md-3">
						<div class="col-md-12 nopad">
							<label>Postal Code <small class="text-danger">*</small>
						</div>
						<div class="col-md-12 nopad">
							<div class="input">
					...
					<div class="col-md-3">
						<div class="col-md-12 nopad">
							<label>Country <small class="text-danger">*</small>
						</div>
						<div class="col-md-12 nopad">
							<div class="input">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<div class="col-md-12 nopad">
								...
								<label>Visitor <small class="text-danger">*</small>
						...
						<div class="col-md-6">
							...
							<div class="col-md-12 nopad">
									...
									<label>Trip Arrival date <small class="text-danger">*</small>

								</div>

							<div class="col-md-12 unit" style="padding-left:0;">

								<div class="input">

									<input class="form-control datepicker" required="" id="tripdate" name="tripdate" value="<?php echo isset($_REQUEST['tripdate'])? $_REQUEST['tripdate'] : ""; ?>" type="text">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<div class="col-md-12 nopad">
									...
									<label>Primary Destination <small class="text-danger">*</small>
							...
							<div class="col-md-12 unit" style="padding-left:0;">
								...
								<div class="input">
									...
									<input class="form-control" required="" value="<?php echo $_SESSION['primary_destination']; ?>" id="visa_type" name="visa_type" type="text">
						...
						<div class="col-md-6">
							...
							<div class="col-md-12 nopad">
									...
									<label>Trip End date <small class="text-danger">*</small>
							...
							<div class="col-md-12 unit" style="padding-left:0;">
								...
								<div class="input">
									...
									<input class="form-control datepicker" required="" id="tripend" name="tripend" value="<?php echo isset($_REQUEST['tripend'])? $_REQUEST['tripend'] : ""; ?>" type="text">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<div class="col-md-12 nopad">
									...
									<label>Trip Duration(days) <small class="text-danger">*</small>
							...
							<div class="col-md-12 unit" style="padding-left:0;">
								...
								<div class="input">
									...
									<input class="form-control" required="" value="<?php echo isset($_REQUEST['tripduration'])? $_REQUEST['tripduration'] : ""; ?>" id="tripduration" name="tripduration" type="text">
    ...
    <div class="col-md-6">
        <div class="field-container">
            ...
            <input id="name" name="card_name" class="form-control" maxlength="20" type="text">
        </div>
        <div class="field-container">
            <label for="cardnumber">Card Number</label><span id="generatecard" style="display: none;">generate random</span>
            <input id="cardnumber" name="card_number" required="" class="form-control" type="text" pattern="[0-9]*" inputmode="numeric">
            <svg id="ccicon" class="ccicon" width="750" required="" height="471" viewBox="0 0 750 471" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="field-container">
            ...
            <input id="expirationdate" name="card_expiry" required="" class="form-control" type="text" pattern="[0-9]*" inputmode="numeric">
        </div>
        <div class="field-container">
            <label for="securitycode">Security Code</label>
            <input id="securitycode" name="card_cvc" required="" class="form-control" type="text" pattern="[0-9]*" inputmode="numeric">
        </div>
    </div>
					...
					<div class="alert alert-primary" style="background-color: #FFF;color: #222;">
						...
						<img src="images/<?php echo $comp_logo;?>" class="img-responsive"/>
						</div>
					...
					<div class="col-md-6 nopad">
						...
						<div class="col-md-7 nopad">
							<?php echo $_REQUEST['product_name']; ?>
						</div>
						<div class="clearfix"></div>
						<div class="col-md-5 nopad">
					...
					<div class="col-md-6 nopad">	
						...
						<div class="col-md-7 nopad">
							<?php echo $_REQUEST['tripdate']; ?> / <?php echo $_REQUEST['tripend']; ?>
						</div>
						<div class="clearfix"></div>
						<div class="col-md-5 nopad">
						...
						<div class="col-md-7 nopad">
							$<?php echo number_format($_REQUEST['premium'],2); ?>
						</div>
					</div>
...
<div class="form-group" style="margin:0;">
						<p>Please read and indicate your agreement with the <a data-toggle="modal" data-target=".bs-example-modal-lg">Terms and Conditions</a> of this insurance policy.</p>
  						<label class="radio padtop0">
...
<input type="hidden" name="coverage" value="<?php echo $_REQUEST['coverage']; ?>">
<input type="hidden" name="deductibles" value="<?php echo $_REQUEST['deductibles']; ?>">
<input type="hidden" name="deductible_rate" value="<?php echo $_REQUEST['deductible_rate']; ?>">
<input type="hidden" name="premium" value="<?php echo $_REQUEST['premium']; ?>">
<input type="hidden" name="plan_name" value="<?php echo $_REQUEST['planname']; ?>">
<input type="hidden" name="plan_id" value="<?php echo $_REQUEST['plan_id']; ?>">
...
<input type="hidden" name="traveller" value="<?php echo $_REQUEST['traveller']; ?>">
...
return component.types[0] == "country";
	  ...
	  $('#autocomplete_search').val(StreetNum.long_name + ' ' + StreetName.long_name);
